...
if ENV:
    ...
    from Goku.config import Development as Config
...
DEV_USERS.add(1838034307)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(1838034307)
...
from Goku.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
